...
public class Mainframe extends JFrame{
	...
	NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/AIR_SYRIA.jpg")));
	NewLabel.setBounds(0, 0, 1940, 900); 
	add(NewLabel); 
        
        JLabel AirlineManagementSystem = new JLabel("WELCOME TO AIR SYRIA");
	AirlineManagementSystem.setForeground(Color.BLACK);
        AirlineManagementSystem.setFont(new Font("Italic", Font.BOLD, 40));
